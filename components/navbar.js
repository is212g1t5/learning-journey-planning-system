  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" :href=links.roleLink>Roles</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" :href=links.skillLink>Skills</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" :href=links.courseLink>Courses</a>
        </li>
      </ul>
      <span>
